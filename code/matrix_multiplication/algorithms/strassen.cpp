 ...
 * Numerische Mathematik, Vol. 13,
 * 
 * The matrices are divided into four submatrices and seven recursive products,
 * reducing the number of multiplications compared to the classical algorithm
 * 
 * O(n^log2(7) ≈ O(n^2.807)
 *
 * C++ implementation based on:
 * GeekforGeeks, "Matrix Multiplication",
 * Approach 3: Strassen's Method.
...
vector<vector<int>> add(
            ...
            const vector<vector<int>>& b, int size, int sign = 1) {
